...
function AppCard (){
    ...
    return (
        ...
        <iframe scrolling="no" className="w-300" height="450" src="https://www.instagram.com/hruta12/embed"></iframe>
        <iframe className="s_map_embedded o_not_editable" src="https://maps.google.com/maps?q=250%20Executive%20Park%20Blvd%2C%20Suite%203400%20San%20Francisco%20California%20(US)%20United%20States&amp;t=m&amp;z=12&amp;ie=UTF8&amp;iwloc=&amp;output=embed" width="100%" height="100%" frameBorder="0" scrolling="no" marginHeight="0" marginWidth="1"></iframe>
        </div>
    )
